...
So a bunch of e/accs have been floating acrossing my [twitter](https://twitter.com/tyepduser) 
...
Transitioning from the idea that AGI is worth achieving that will 'cure' humanity are 
...
### Note
On a side note, I do also want to acknowledge that most terms used in AI are so exxagerated in terms of 
how BIG they try to sound while just being a insignificant (and intuitive) change in some prior conceptual formula.
